...
[%always]
<<<
[id='sec.asiatisches_rindfleisch_mit_gemüse']

indexterm:[Asiatisches Rindfleisch mit Gemüse]
...
* <<sec.asiatisches_rindfleisch_mit_gemüse, Asiatisches Rindfleisch mit Gemüse>>
