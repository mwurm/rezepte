...
""")
        ...
        cookbook_categories = ["Basis", "Appetithäppchen", "Beilagen", "Salate", "Suppen", "Pasta", "Pizza & Co.", "Aufläufe", "Reisgerichte", "Fleischgerichte", "Geflügel", "Fisch", "Desserts", "Mehlspeisen", "Gebäck", "Kuchen"]
